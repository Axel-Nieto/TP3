...
{
    public class MenuCesar: Menu
    {
        /// <summary>
        /// Crea un objeto de la clase MenuCesar
        /// </summary>
        /// <param name="pNombre">Nombre del menu</param>
        public MenuCesar(String pNombre) : base(pNombre) { }
        ...
        {
            String cadena = iFabricaEncritadores.GetEncriptador("Cesar").Encriptar(pCadena);
        ...
        {
            String cadena = iFabricaEncritadores.GetEncriptador("Cesar").Desencriptar(pCadena);
