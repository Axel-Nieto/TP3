...
{
    public class MenuInversa: Menu
    {
        /// <summary>
        /// Crea un objeto de la clase MenuInversa
        /// </summary>
        /// <param name="pNombre">Nombre del menu</param>
        public MenuInversa(String pNombre) : base(pNombre) { }
        ...
        {
            String cadena = iFabricaEncritadores.GetEncriptador("Inv").Encriptar(pCadena);
        ...
        {
            String cadena = iFabricaEncritadores.GetEncriptador("Inv").Desencriptar(pCadena);
